...
function optionsByWindowSize() {
	...
	if (winw > 1600) { itms = 4; stpg = 1; pltd = 4; }
	else if (winw > 1230) { itms = 4; stpg = 1; pltd = 4; }
	else if (winw > 980) { itms = 4; stpg = 1; pltd = 4; }
	else if (winw > 750) { itms = 3; stpg = 1; pltd = 4; }
	else if (winw > 510) { itms = 2; stpg = 1; pltd = 4; }
	else { itms = 1; stpg = 1; pltd = 4; }
}
